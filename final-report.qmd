...
![Description de l'image](https://raw.githubusercontent.com/ellitna/SOI/main/images/timeline.png)
...
![Description de l'image](https://raw.githubusercontent.com/ellitna/SOI/main/images/fordson.png)
...
![Description de l'image](https://raw.githubusercontent.com/ellitna/SOI/main/images/waterloo.png){width="586"}
...
![Description de l'image](https://raw.githubusercontent.com/ellitna/SOI/main/images/graph1IPS.png)

![Description de l'image](https://raw.githubusercontent.com/ellitna/SOI/main/images/graph2ips.png)
...
# Main ggplot setup with annotations for selected actors
p <- ggplot(data, aes(
    x = Share_since_2019,
    y = Number_of_patent_families,
  ...
  # Add smaller highlighted circles for selected actors
  geom_point(
    data = subset(data, Applicant_name %in% c("Bayer", "BASF", "Sumitomo Chemical", "Corteva", "Sinochem Holdings", 
                                               "University of California", "Chinese Academy of Agricultural Sciences", 
                                               "KAO", "Pivot Bio")),
    shape = 21, color = "black", fill = NA, size = 3, stroke = 0.5
  ) +
  ...
  scale_color_manual(values = c(
    "Company" = "chartreuse3",
    "Government" = "grey",
    "University and research institution" = "darkgreen"
  )) +
  labs(
...
# Add labels for specific actors with nudging
p <- p +
  geom_text(
    data = subset(data, Applicant_name %in% c("Bayer", "BASF", "Sumitomo Chemical", "Corteva", "Sinochem Holdings", 
                                              "University of California", "Chinese Academy of Agricultural Sciences", 
                                              "KAO", "Pivot Bio")),
    aes(label = Applicant_name), 
    nudge_x = 2, nudge_y = 5, size = 3, color = "grey20"
  )
